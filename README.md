...
spider = Spider(base_url=base_url, format=save_format, save_path=r'D:\Data\NLP\corpus\test')
```
...
然后设置`Spider`的`use_proxy`参数为`True`（默认为`False`），即代码修改为：
```python
spider = Spider(base_url=base_url, format=save_format, save_path=r'D:\Data\NLP\corpus\test', use_proxy=True)
```
即可启用代理
...
```bash
[2020-01-10 16:23:21] [WARNING] [MainThread] [spider.py:22] 指定目录不存在！将创建存储目录D:\Data\NLP\corpus\baike_info
[2020-01-10 16:23:21] [INFO] [MainThread] [spider.py:42] 已处理0条数据，还需处理11条数据
[2020-01-10 16:23:21] [INFO] [MainThread] [spider.py:55] 开始爬取，当前时间为：2020-01-10 16:23:21
[2020-01-10 16:23:22] [INFO] [MainThread] [writer.py:10] 写入地址为：D:\Data\NLP\corpus\baike_info/result.json， 临时文件地址为：D:\Data\NLP\corpus\baike_info/handled.txt
100%|██████████| 11/11 [00:02<00:00,  3.96it/s]
[2020-01-10 16:23:25] [INFO] [MainThread] [spider.py:72] 执行结束, 当前时间为：2020-01-10 16:23:25
[2020-01-10 16:23:25] [INFO] [MainThread] [spider.py:75] 本次共计耗时3.73s，共爬取数据条数为11，平均速度为：2.95(task/s)
```
